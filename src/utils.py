...
def render(df_data, df_data_scaled, len_binary, path_to_embs_file, DATA_SET_NAME, emb_name, WORK_FOLDER):
    ...
    for EMB_NAME in embs_data.keys():
        if EMB_NAME == emb_name:
            ...
            optimiser = ExclusOptimiser(df_data, df_data_scaled, len_binary, embedding,
            ...
            app.layout = config_layout(scatter, explanations, cluster_ids, dashboard, DATA_SET_NAME)
...
"""
    sample n_sample data, and reorder the columns of the data according to the attributes
    :return data and counts of binary attributes
"""
